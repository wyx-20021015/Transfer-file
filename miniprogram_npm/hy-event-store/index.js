...
__DEFINE__(1647927748564, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647927748565,"./event-store":1647927748566}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647927748565, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647927748566, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647927748565,"./utils":1647927748567}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647927748567, function(require, module, exports) {
...
return __REQUIRE__(1647927748564);
})()
